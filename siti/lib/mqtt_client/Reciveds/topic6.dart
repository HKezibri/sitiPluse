...
class MQTTManager6 with ChangeNotifier {
  dynamic payload = "000";
  ...
  void connectMQTT() async{
    ...
    try {
      ...
      client.subscribe("F01/R01/M06/flow", MqttQos.atLeastOnce);
    } catch (e) {
      print('Exception: ');
    }
...
class SalesData6{
  SalesData6(this.time, this.production);
  final String time;
