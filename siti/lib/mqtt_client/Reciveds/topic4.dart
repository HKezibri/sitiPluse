...
class MQTTManager4 with ChangeNotifier {
  dynamic payload = "000";
  ...
  void connectMQTT() async{
    ...
    try {
      ...
      client.subscribe("F01/R01/M04/flow", MqttQos.atLeastOnce);
    } catch (e) {
      print('Exception: ');
    }
...
class SalesData4{
  SalesData4(this.time, this.production);
  final String time;
