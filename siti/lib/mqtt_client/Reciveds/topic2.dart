...
class MQTTManager2 with ChangeNotifier {
  dynamic payload = "000";
  ...
  void connectMQTT() async{
    ...
    try {
      ...
      client.subscribe("F01/R01/M02/flow", MqttQos.atLeastOnce);
    } catch (e) {
      print('Exception: ');
    }
...
class SalesData2{
  SalesData2(this.time, this.production);
  final String time;
