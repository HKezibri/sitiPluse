...
class MQTTManager3 with ChangeNotifier {
  dynamic payload = "000";
  ...
  void connectMQTT() async{
    ...
    try {
      ...
      client.subscribe("F01/R01/M03/flow", MqttQos.atLeastOnce);
    } catch (e) {
      print('Exception: ');
    }
...
class SalesData3{
  SalesData3(this.time, this.production);
  final String time;
