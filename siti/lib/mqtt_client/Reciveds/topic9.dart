...
class MQTTManager9 with ChangeNotifier {
  dynamic payload = "000";
  ...
  void connectMQTT() async{
    ...
    try {
      ...
      client.subscribe("F01/R01/M09/flow", MqttQos.atLeastOnce);
    } catch (e) {
      print('Exception: ');
    }
...
class SalesData9{
  SalesData9(this.time, this.production);
  final String time;
