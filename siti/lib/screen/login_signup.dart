...
import 'package:siti/config/palette.dart';
...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  Container buildSignupSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(MaterialCommunityIcons.account_outline, "Full Name",
              false, false),
          buildTextField(MaterialCommunityIcons.account_outline, "CIN",
              false, false),
          buildTextField(
